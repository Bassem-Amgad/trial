...
extern void LCD_voidInit (void)
{
	...
	// define 8 data Pins
	DIO_voidSetDirection (DIO_u8PinA0,DIO_u8PinOp);//D0
	DIO_voidSetDirection (DIO_u8PinA1,DIO_u8PinOp);//D1
	DIO_voidSetDirection (DIO_u8PinA2,DIO_u8PinOp);//D2
	DIO_voidSetDirection (DIO_u8PinA3,DIO_u8PinOp);//D3
	DIO_voidSetDirection (DIO_u8PinA4,DIO_u8PinOp);//D4
	DIO_voidSetDirection (DIO_u8PinA5,DIO_u8PinOp);//D5
	DIO_voidSetDirection (DIO_u8PinA6,DIO_u8PinOp);//D6
	DIO_voidSetDirection (DIO_u8PinA7,DIO_u8PinOp);//D7
